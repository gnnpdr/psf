...
def check_noise(metric_func, blurred_tensor, psf_tensor, noise, orig_tensor):
    ...
    for step in steps:
        ...
        res_tensor = make_wiener(blurred_tensor, psf_tensor, start_step_noise)
        ...
        while cur_metric < new_metric:
            ...
            res_tensor = make_wiener(blurred_tensor, psf_tensor, new_noise)
...
for filename in all_files:
    ...
    if os.path.isfile(file_path):
        ...
        res_np = make_save_wiener(blurred_tensor, psf_tensor, best_psnr_noise, orig_name)
        res_np = make_save_wiener(blurred_tensor, psf_tensor, best_ssim_noise, orig_name)
        orig_np = tensor2np(orig_tensor)
